...
<div align="center">
  ...
  <!-- Build Status -->
  <a href="https://travis-ci.org/hashkingsjs/choo">
    <img src="https://img.shields.io/travis/hashkingsjs/choo/master.svg?style=flat-square"
      alt="Build Status" />
  </a>
  <!-- Test Coverage -->
  <a href="https://codecov.io/github/hashkingsjs/choo">
    <img src="https://img.shields.io/codecov/c/github/hashkingsjs/choo/master.svg?style=flat-square"
      alt="Test Coverage" />
  </a>
  <!-- Downloads -->
  <a href="https://npmjs.org/package/choo">
...
this is [nanobus](https://github.com/hashkingsjs/nanobus).
...
[option](#app--hashkingsopts) to `false`. Regardless, when a hash is found we also
...
[nanohref](https://github.com/hashkingsjs/nanohref) module. This can be
...
overriden with [options](#app--hashkingsopts).
